...
import { LayoutDashboard, User, LogOut, Settings, ShieldCheck, BarChart, MessageSquare, Megaphone } from 'lucide-react';
...
export default function DashboardLayout() {
    ...
    const navItems = [
        ...
        { icon: Megaphone, label: 'Meus Anúncios', href: '/dashboard/ads' },
