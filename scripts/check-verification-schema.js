...
async function main() {
    try {
        ...
        if (names.includes('verification_documents')) {
            console.log('✅ Collection "verification_documents" exists.');
        } else {
            console.log('❌ Collection "verification_documents" DOES NOT EXIST.');
        }
