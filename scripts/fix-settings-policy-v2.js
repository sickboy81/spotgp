...
import { createDirectus, rest, authentication, readRoles, createPolicy, readPolicies, updateRole, createPermission } from '@directus/sdk';
...
async function getOrCreatePolicy(name, icon) {
    const existing = await client.request(readPolicies({
